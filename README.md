...
Get [maven-notifier](http://dl.bintray.com/jcgay/maven/fr/jcgay/maven/maven-notifier/0.11/maven-notifier-0.11.jar) and copy it in your `$M2_HOME/lib/ext` folder.

### Maven < 3.1

Get [maven-notifier](http://dl.bintray.com/jcgay/maven/fr/jcgay/maven/maven-notifier/0.11/maven-notifier-0.11.zip) and extract it in your `$M2_HOME/lib/ext` folder.
