...
Get [maven-notifier](http://dl.bintray.com/jcgay/maven/fr/jcgay/maven/maven-notifier/2.0.0/maven-notifier-2.0.0.jar) and copy it in `%M2_HOME%/lib/ext` folder.
...
Get [maven-notifier](http://dl.bintray.com/jcgay/maven/fr/jcgay/maven/maven-notifier/2.0.0/maven-notifier-2.0.0.jar) and copy it in your `$M2_HOME/lib/ext` folder.

### Maven < 3.1

Get [maven-notifier](http://dl.bintray.com/jcgay/maven/fr/jcgay/maven/maven-notifier/2.0.0/maven-notifier-2.0.0.zip) and extract it in your `$M2_HOME/lib/ext` folder.
